...
def _import_gpu_stack():
    ...
    from gpu4pyscf.qmmm.embedding.embedding_dft_try1_ml_fix_core_bath import SingleFragmentEmbedding_ML, OneStepRKS
...
def run_energy_block(config, mol=None):
    ...
    emb_hl = SingleFragmentEmbedding_ML(mf_outer_hl, mf_inner_hl, fragment, n_bath=60, n_core=2, verbose=4)
