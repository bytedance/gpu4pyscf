...
def _import_gpu_stack():
    ...
    from gpu4pyscf.qmmm.embedding.test_dft_embedding_try1_ml_dualbasis import SingleFragmentEmbedding_ML_DualBasis, DualBasisOneStepRKS
    return gto, rks, SingleFragmentEmbedding_ML_DualBasis, DualBasisOneStepRKS
...
def run_energy_block(config, mol=None):
    ...
    config_small["basis_set"] = "sto-3g"
    mol_small = build_mol(config_small)
    print("1.2")
    ...
    mf_outer_hl = OneStepRKS(mol, mol_small, eval_lda_guess, xc=xc_low).density_fit()
